...
//            1 => ['file', dirname(__FILE__) . '/logs/process-stdout-'.$scriptName.'.log', 'a'], // stdout is a file that the process will write in
//            2 => ['file', dirname(__FILE__) . '/logs/process-stderr-'.$scriptName.'.log', 'a'], // stderr is a file that the process will write in
//        ];
